...
def gerer_modules_speciaux(question: str, question_clean: str) -> Optional[str]:
    ...
    if not message_bot and any(mot in question_clean for mot in ["qui", "quand", "où", "combien", "quel", "quelle"]):
        base_connaissances = {
                ...
                # 📚 histoire 
                "quand a ete signe le traite de maastricht": "🇪🇺 Le traité de Maastricht, fondateur de l’Union européenne, a été signé en **1992**.",
                "qui a ete le premier president des etats unis": "🇺🇸 **George Washington** a été le premier président des États-Unis, en 1789.",
                "quand a ete invente le vaccin contre la variole": "💉 Le premier vaccin contre la variole a été développé par **Edward Jenner** en **1796**.",
                "qu'est ce que la bataille de waterloo": "⚔️ La bataille de Waterloo en **1815** marque la défaite finale de Napoléon Bonaparte.",
                "quand a ete fondee la ville de rome": "🏛️ La légende dit que Rome a été fondée en **753 av. J.-C.** par **Romulus**.",
                "qui etait jeanne d arc": "🛡️ **Jeanne d’Arc** était une héroïne française du XVe siècle, brûlée vive à 19 ans, canonisée plus tard.",
                "quand a ete signe l armistice de 1918": "🕊️ L’armistice mettant fin à la Première Guerre mondiale a été signé le **11 novembre 1918**.",
                ...
                "quand a ete decouverte la pierre de rosette": "📜 La pierre de Rosette a été découverte en **1799** et a permis de décrypter les hiéroglyphes.",
                "qui etait rosa parks": "✊ **Rosa Parks** est une figure clé de la lutte pour les droits civiques aux États-Unis. Elle a refusé de céder sa place dans un bus en 1955.",
                "qu est ce que la revolution d octobre": "🟥 La **révolution d’octobre 1917** en Russie a conduit à la prise du pouvoir par les bolcheviks.",
                "quand a ete abolie la monarchie en france": "🇫🇷 La monarchie a été abolie le **21 septembre 1792**, donnant naissance à la Première République.",
                "qui etait martin luther king": "🗣️ **Martin Luther King Jr.** était un leader pacifiste emblématique de la lutte contre la ségrégation raciale aux États-Unis.",
                ...
                "quand a ete assassine john f kennedy": "🇺🇸 Le président américain **John F. Kennedy** a été assassiné le **22 novembre 1963** à Dallas.",
                "qu est ce que l independance de l inde": "🇮🇳 L’**Inde** est devenue indépendante de l’Empire britannique le **15 août 1947**, grâce notamment à **Gandhi**.",
                "quand a commence l apartheid en afrique du sud": "⚖️ Le régime d’**apartheid** a été instauré officiellement en **1948** en Afrique du Sud.",
                "qui a invente la democratie": "🏛️ Le concept de **démocratie** est né à **Athènes**, en Grèce antique, au Ve siècle av. J.-C.",
                ...
                "quand a ete ecrit le code napoleon": "📚 Le **Code civil**, aussi appelé **Code Napoléon**, a été promulgué en **1804**."
            }
